...
mongoose.connect('mongodb+srv://blz:<PASSWORD>@cluster0-nslbx.mongodb.net/reciepes?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true})
.then(() => {
